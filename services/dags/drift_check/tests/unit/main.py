...
from services.dags.drift_check.src.modules.configs.airflow.xcom import DriftCheckXComKeys
...
def test_main(mocker: MockerFixture):
    mocker.patch(
        target="services.dags.drift_check.src.main.drift_check",
        return_value=(
            True,
            {
    ...
    from services.dags.drift_check.src.main import main
    main()
