...
from services.dags.drift_check.src.modules.environment.drift_check import DriftCheckEnvironment

class TestDriftCheckEnvironment:
    def test_instance(self):
        from services.dags.drift_check.src.modules.environment.drift_check import drift_check_environment
