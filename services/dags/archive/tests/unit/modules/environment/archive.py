...
from services.dags.archive.src.modules.environment.archive import ArchiveEnvironment

class TestArchiveEnvironment:
    def test_instance(self):
        from services.dags.archive.src.modules.environment.archive import archive_environment
