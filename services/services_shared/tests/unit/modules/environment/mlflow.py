...
from services_shared.src.modules.environment.mlflow import MLflowEnvironment

class TestMLflowEnvironment:
    def test_instance(self):
        from services_shared.src.modules.environment.mlflow import mlflow_environment
