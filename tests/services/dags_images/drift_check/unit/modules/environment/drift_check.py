...
from drift_check.modules.environment.drift_check import DriftCheckEnvironment

class TestDriftCheckEnvironment:
    def test_instance(self):
        from drift_check.modules.environment.drift_check import drift_check_environment
